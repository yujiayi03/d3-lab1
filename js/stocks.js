...
const x = d3.scaleUtc()
    .domain(d3.extent(allValues, d => d.Date)) /* TODO: Define domain for x axis */
    .range([0, width]); /* TODO: Define width range in pixels */
...
const y = d3.scaleLinear()
    ...
    .range([height, 0]); /* TODO: define height range in pixels */
...
const xAxis = d3.axisBottom(x) // TODO: Define X axis, format ticks to show only years 
...
const yAxis = d3.axisLeft(y) // TODO: Define Y axis, format ticks to show $ sign
    .tickFormat(d => `$${d}`);
...
const line = d3.line()
    .x(d => x(d.Date)) // TODO: map Date to x-axis
    .y(d => y(d.Close)) // TODO: map 'Close' price to y-axis
...
svg.append('text')
    ...
    .attr('x', width / 2) // TODO: center the title
    .attr('y', -margin.top / 2) // TODO: put the title above the chart
...
svg.append('text')
    ...
    .attr('y', -margin.left + 40) // TODO: put the label to the left of y-axis
    .attr('text-anchor', 'middle')
    .style('font-size', '14px')
    .text('Stock Price (USD)'); // TODO: add axis label
...
stocks.forEach((stock, i) => {
    ...
    legendRow.append('text')
        .attr('x', 25) // TODO: define x-coordinate of the text label starting point
        .attr('y', 10) // TODO: define y-coordinate of the text label starting point
